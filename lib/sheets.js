...
// Watchlist rows start at row 7 (row 6 is the header). Column A is blank in
// the source sheet, so the range starts at B to keep row[0] = DATE and match
// the column indices in lib/scoring.js.
export const WATCHLIST_RANGE = 'B7:Q40';
