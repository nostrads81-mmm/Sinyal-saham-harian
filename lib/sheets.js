...
const DEFAULT_SETTINGS_VALUES = [50000000, 0.005, 6, 0.0015, 0.0025, 10000, 10000000, 'mid'];
...
export async function getSettings(token, sheetId) {
  const rows = await getValues(sheetId, 'Settings!A2:H2', token);
...
export async function updateSettings(token, sheetId, { capital, maxSlots, entryMode }) {
